...
export default async function Footer() {
  ...
  return (
    <footer
      className='footer bg-primary-900 text-white dark:bg-primary-800'
      aria-labelledby='footer-heading'
    >
      <h2 id='footer-heading' className='sr-only'>
        Footer
      </h2>
      <div className='mx-auto w-full pt-12 pb-6 lg:pt-16 px-6 sm:px-7 lg:px-8 max-w-7xl'>
        <div className='grid grid-cols-1 gap-7 md:grid-cols-[350px,1fr]'>
          <div>
            <a href='/'>
              ...
              <svg
                ...
                className='h-10 w-40 text-white duration-200 hover:text-accent-500 sm:h-12'
              >
                <path
          ...
          <div className='row-start-4 row-end-5 sm:row-start-2 sm:row-end-3'>
            <div className='prose mb-4 text-sm text-white prose-a:text-white prose-a:hover:text-primary-200'>
              <p>
                Call Us:{' '}
                <a target='_blank' rel='noopener noreferrer' href='tel:202-743-0933'>
                  (202)-743-0933
                </a>
              </p>
              <p>
                Email Us:{' '}
                <a target='_blank' rel='noopener noreferrer' href='mailto: info@theresourcekey.com'>
                  info@theresourcekey.com
                </a>
              </p>
            </div>
          </div>
          <div className='sm:col-start-2 sm:col-end-3 sm:row-start-1 sm:row-end-4'>
            <div className='grid grid-cols-2 gap-8 lg:grid-cols-4 xl:col-span-4 '>
              <div className='mt-6 md:mt-8 lg:mt-0'>
                <span className='mb-2 font-bold uppercase text-primary-400'>Services</span>
                <ul className='mt-4 space-y-4'>
                  <li>
                    <a href='/services/speaking/'>
                      <span className='font-medium hover:text-primary-300'>
                        Speaking Engagements and Custom Programs
                      </span>
                    </a>
                  </li>
                  <li>
                    <a href='/services/office-hours/'>
                      <span className='font-medium hover:text-primary-300'>Office Hours</span>
                    </a>
                  </li>
                  <li>
              ...
              <div className='mt-6 md:mt-8 lg:mt-0'>
                <span className='mb-2 font-bold uppercase text-primary-400'>Community</span>
                <ul className='mt-4 space-y-4'>
                  <li>
                    <a href='/case-studies/'>
                      <span className='font-medium hover:text-primary-300'>Case Studies</span>
                    </a>
                  </li>
                  <li>
                    <a href='/community-experts/'>
                      <span className='font-medium hover:text-primary-300'>Community Experts</span>
                    </a>
                  </li>
                  <li>
                    <a href='/community-partners/'>
                      <span className='font-medium hover:text-primary-300'>Community Partners</span>
                    </a>
                  </li>
                  <li>
                    <a href='/sponsorships/'>
                      <span className='font-medium hover:text-primary-300'>
                        The Resource Key Volunteer Sponsorship Program
                      </span>
                    </a>
                  </li>
                </ul>
              ...
              <div className='mt-6 md:mt-8 lg:mt-0'>
                <span className='mb-2 font-bold uppercase text-primary-400'>Help</span>
                <ul className='mt-4 space-y-4'>
                  <li>
                  ...
                  <li>
                    <a target='_blank' rel='noopener noreferrer' href='/sitemap.xml'>
                      <span className='font-medium hover:text-primary-300'>Sitemap</span>
                    </a>
                  </li>
                </ul>
              </div>
              <div className='mt-6 md:mt-8 lg:mt-0'>
                <span className='mb-2 font-bold uppercase text-primary-400'>Company</span>
                <ul className='mt-4 space-y-4'>
                  <li>
                    <a href='/about-us/'>
                      <span className='font-medium hover:text-primary-300'>About Us</span>
                    </a>
                  </li>
                  <li>
                    <a href='/contact/'>
                      <span className='font-medium hover:text-primary-300'>Contact Us</span>
                    </a>
                  </li>
                  <li>
                    <a href='/events/'>
                      <span className='font-medium hover:text-primary-300'>Events</span>
                    </a>
                  </li>
                  <li>
                    <a href='/blog/'>
                      <span className='font-medium hover:text-primary-300'>Blog</span>
                    </a>
                  </li>
                  <li>
                    <a href='/privacy-policy/'>
                      <span className='font-medium hover:text-primary-300'>Privacy Policy</span>
                    </a>
                  </li>
                </ul>
              </div>
        ...
        <hr className='my-6 border-accent-500 border-opacity-40' />
        <div className='flex flex-col items-center justify-between gap-4 lg:flex-row'>
          <div>
            <p>Copyright © 2023 The Resource Key</p>
          </div>
          <ul className='flex items-center space-x-3'>
            <li>
              <a
                ...
                href='https://www.instagram.com/theresourcekey/'
              >
                <svg
                  className='h-5 w-5 transition hover:opacity-75'
                  xmlns='http://www.w3.org/2000/svg'
                  viewBox='0 0 24 24'
                  aria-hidden='true'
                >
            ...
            <li>
              <a
                ...
                target='_blank'
                rel='noopener noreferrer'
                href='https://www.facebook.com/theresourcekey'
              >
                <svg
                  className='h-5 w-5 transition hover:opacity-75'
                  xmlns='http://www.w3.org/2000/svg'
            ...
            <li>
              <a
                ...
                target='_blank'
                rel='noopener noreferrer'
                href='https://www.linkedin.com/company/the-resource-key/'
              >
                <svg
                  className='h-5 w-5 transition hover:opacity-75'
                  xmlns='http://www.w3.org/2000/svg'
            ...
            <li>
              <a
                ...
                target='_blank'
                rel='noopener noreferrer'
                href='https://twitter.com/theresourcekey'
              >
                <svg
                  className='h-5 w-5 transition hover:opacity-75'
                  viewBox='0 0 24 24'
